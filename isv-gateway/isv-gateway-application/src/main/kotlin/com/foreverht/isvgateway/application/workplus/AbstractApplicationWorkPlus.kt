...
abstract class AbstractApplicationWorkPlus {
    ...
    suspend fun getRemoteAccessToken(accessToken:String): Future<Pair<ISVClientExtraForWorkPlusApp,String>> {
        return try {
            ...
            if(Objects.nonNull(isvClientToken) && isvClientToken!!.extra.accessTokenValid()){
                val result = Pair(isvClientToken.client.extra as ISVClientExtraForWorkPlusApp,isvClientToken.extra.accessToken())
